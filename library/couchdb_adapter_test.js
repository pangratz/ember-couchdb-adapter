...
test("deleting a person makes a DELETE to /DB_NAME/:id", function() {
  ...
  expectAjaxCall('DELETE', "/DB_NAME/abc", {
    rev: '1-abc'
  });
...
xtest("belongsTo relationship dirties if item is deleted", function() {
...
xtest("belongsTo relationship dirties item if item is updated", function() {
